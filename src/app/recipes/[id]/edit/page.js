...
export default function EditRecipe() {
    ...
    const fetchRecipe = async () => {
      try {
        ...
        setForm({
          ...
          category: data.category || 'italian',
    ...
    return (
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-pulse">
        ...
        {Array.from({ length: 3 }).map((_, i) => (
          <div key={i} className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-5 mb-5 space-y-3">
    ...
    return (
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl p-8 text-center">
          ...
          <Link href="/browse" className="text-orange-600 hover:text-orange-700 font-medium text-sm mt-3 inline-block">
            Back to Browse
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-50">Edit Recipe</h1>
        <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">Update the details of your recipe</p>
      </div>
